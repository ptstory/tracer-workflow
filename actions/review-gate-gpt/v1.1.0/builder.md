...
Recommended:
- Custom Actions: ON, using `https://raw.githubusercontent.com/ptstory/tracer-workflow/main/actions/review-gate-gpt/v1.1.0/actions/github-review-gate.openapi.yaml`.
...
Secret:
- a classic GitHub PAT from tracer-review-bot with `repo` scope. The bot must be a write collaborator on each private repository using the gate. See `actions/IMPORT.md` for the token expiry and access constraints.
