...
For a private, single-user GPT, use a **fine-grained GitHub personal access token** as the Action's Bearer API key.
...
5. Add a Custom Action and paste `actions/github-review-gate.openapi.yaml`.
6. Configure Action authentication as API Key -> Bearer and provide the fine-grained GitHub PAT.
